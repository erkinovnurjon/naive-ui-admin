          ...
          <div class="space-y-4">
            <div>
              <n-form-item label="Sarlavha" required>
                <n-input
                  ...
                  placeholder="Nazariy qism sarlavhasini kiriting"
                  @input="emitUpdate"
                />
              </n-form-item>
            </div>
            ...
            <div>
              <n-form-item label="Tavsifi" required>
                <n-input
                  v-model:value="practice.content"
                  type="textarea"
              ...
              <div class="space-y-4">
                <div class="flex items-center justify-between">
                  <div class="flex items-center gap-2">
                    ...
                    <h6 class="text-base font-semibold m-0">
                      Nazariy qism Fayli
                    </h6>
                  </div>
                  <n-button
...
const handleMaterialUpload = async (event: Event, index: number) => {
  ...
  formData.append("EntityName", "lessonReading");
  formData.append("File", file);

  console.log("FormData yaratildi, API ga yuborilmoqda...");
...
const getFileUrl = (fileId: string) => {
  const url = `${core_cdn.value}/Media/Get?entityName=lessonReading&fileId=${fileId}`;
  return url;
};
